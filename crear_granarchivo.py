...
# Creación del archivo .xlsx con todos los datos     
df_feb.to_excel('Febrero_Completo.xlsx', sheet_name='Datos', engine='openpyxl') # Lo creo con la terminación .xlsx para que si se vuelve a ejecutar no se lea con el bucle de arriba
